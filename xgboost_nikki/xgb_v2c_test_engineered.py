# =============== XGBoost V2 Feature Engineering ===============
# Basic parameters and 5-fold CV with engineered features 
# Seleted + Created Features
# Overall CV AUC = 0.72227, Accuracy = 0.6814
# ----------------------------------------------------
...
# ---------- Load data ----------
train = pd.read_csv(f"{DATA_DIR}/train_ft.csv")
test = pd.read_csv(f"{DATA_DIR}/test_ft.csv")
...
# %%
submission.to_csv(OUTPUT_DIR / "xgb_v2_feature_engi.csv", index=False)
print("Saved xgb_v2_feature_engi.csv to", OUTPUT_DIR)
# %%
