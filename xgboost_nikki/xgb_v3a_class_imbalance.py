# =============== XGBoost V3 Class Imbalance Handling ===============
# Basic parameters and 5-fold CV, with feature reduction
# Added scale_pos_weight to handle class imbalance (87k vs 52k)
# 
# Overall CV AUC = 0.72305, Accuracy = 0.6635
# ----------------------------------------------------
...
# %%
submission.to_csv(OUTPUT_DIR / "xgb_v3_class_imbalance.csv", index=False)
print("Saved xgb_v3_class_imbalance.csv to", OUTPUT_DIR)
# %%
